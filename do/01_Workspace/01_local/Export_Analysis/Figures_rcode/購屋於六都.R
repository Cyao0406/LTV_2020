...
path <- "C:/Users/user/OneDrive/桌面/work/114/RA with Tzu-Ting/houseloan/result/Dynamic_DID_results.xlsx"

# 讀第一個工作表、全部欄位先以文字讀入，避免 "0.003***" 被吃掉
raw <- read_excel(path, sheet = 3, col_types = "text")
...
# 確保輸出資料夾存在
outdir <- "C:/Users/user/OneDrive/桌面/work/114/RA with Tzu-Ting/houseloan/figures/購屋於六都"
